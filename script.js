(function () {
  ...
  let messageWin = "Parabéns, vai ganhar um ban ;)";
  let messageLose = "O burro é mais inteligente do que você ?";
  let clicks = 0;
  const N = 180;
  // SOUND
  let soundError = new Howl({
    src: [
      "https://s3-us-west-2.amazonaws.com/s.cdpn.io/953/151309__tcpp__beep1-resonant-error-beep.wav",
    ],
  });

  let soundWin = new Howl({
    src: [
      "https://s3-us-west-2.amazonaws.com/s.cdpn.io/953/391539__mativve__electro-win-sound.wav",
    ],
  });

  let soundJingle = new Howl({
    src: [
      "https://s3-us-west-2.amazonaws.com/s.cdpn.io/953/411420__ihaksi__deck-the-halls-christmas-jingle-played-with-bells.wav",
    ],
  });
